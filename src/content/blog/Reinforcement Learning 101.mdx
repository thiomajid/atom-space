...
- **Game playing**: <Link to="https://arxiv.org/abs/1712.01815" label="AlphaGo"/>
- **Robotics**: training robots to perform tasks in the real world. You can have a look at
  <Link to="https://huggingface.co/lerobot" label="LeRobot" /> by 🤗Hugging Face
  for instance.
- **Finance**: it can be used for optimization problems in finance
- **NLP**: modern large language models like <Link to="https://arxiv.org/abs/2312.11805" label="Gemini" />
  or <Link to="https://arxiv.org/abs/2302.13971" label="LLaMA"/> are trained using
  <Link to="https://arxiv.org/abs/2305.18438" label="RLHF" />
